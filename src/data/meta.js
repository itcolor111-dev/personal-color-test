...
export const CONFIG = {
    ...
    INNER_TEST_URL: "https://itcolor.kr/innertest",
...
export const RESULT_PAGE = {
    ko: {
        ...
        innerTestBtn: "컬러성향테스트 바로가기",
        productBtn: "나만의 컬러 아이템 구매하기",
        courseBtn: "퍼스널컬러 강의 및 자격증 문의",
    ...
    en: {
        ...
        innerTestBtn: "Take the Inner Color Test",
        productBtn: "Shop my signature color items",
        courseBtn: "Personal Color Lectures & Certification",
    ...
    zh: {
        ...
        celebTitle: "参考明星",
        aiTipBtn: "✨ 个人色彩运用指南",
        innerTestBtn: "立即进行色彩性格测试",
        productBtn: "购买我的专属色彩单品",
        courseBtn: "个人色彩课程及资格认证咨询",
    ...
    ja: {
        ...
        innerTestBtn: "カラー性向テストはこちら",
        productBtn: "自分だけのカラーアイテムを購入する",
        courseBtn: "パーソナルカラー講座・資格のお問い合わせ",
